...
class MedicinalPlant extends Seeder
{
    ...
    public function run()
    {
        ...
        $plant->characteristic  = 'Là loại cỏ sống lâu năm, thân có rãnh dọc.
                                Lá mọc so le không cuống, màu 2 mặt lá khác nhau, mặt trên nhẵn, màu lục sẫm.
                                Mặt dưới trắng tro, có nhiều lông nhỏ';
        ...
        $plant1->characteristic  = 'Cây thảo, cao 0,5- 1m. Lá mọc đối, mép khía răng, mặt dưới tím tía, có khi hai mặt đều tía, nâu hay màu xanh lục có lông nhám.
                                    Hoa nhỏ màu trắng mọc thành xim co ở đầu cành, màu trắng hay tím, mọc đối, 4 tiểu nhị không thò ra ngoài hoa.
                                    Quả bế, hình cầu. Toàn cây có tinh dầu thơm và có lông. ';
        ...
        $plant4->characteristic  = 'Toàn thân không lông. Lá kép gồm 3 lá chét mọc so le, lá chét giữa to và dài hơn lá chét hai bên. Hoa màu tím nhạt.
        ...
        $plant5->characteristic  = 'Toàn thân không lông. Lá kép gồm 3 lá chét mọc so le, lá chét giữa to và dài hơn lá chét hai bên. Hoa màu tím nhạt.
                                    Quả giáp dài, tròn, trong chứa 7 đến 10 hạt màu đen';
        $plant5->location        = '';
        ...
        $plant6->characteristic  = 'Toàn thân không lông. Lá kép gồm 3 lá chét mọc so le, lá chét giữa to và dài hơn lá chét hai bên. Hoa màu tím nhạt.
                                    Quả giáp dài, tròn, trong chứa 7 đến 10 hạt màu đen';
        $plant6->location        = '';
